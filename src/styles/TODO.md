...
[  ] After choosing out of the three equations, it briefly shows the underlying equation, with something like [- extra value] written in green. This just shouldn't be shown
